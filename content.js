// Study Focus Assistant - Content Script
// Provides communication bridge between web pages and extension

// Listen for messages from the background script
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  switch (message.action) {
    case 'showDistractionPrompt':
      showDistractionPrompt(message.domain);
...
// Function to show distraction prompt (backup method)
function showDistractionPrompt(domain) {
...
console.log('Study Focus Assistant content script loaded on:', getCurrentDomain());